...
void printExecutionTime(string msg, Func f, Args&&... args) {
    ...
    f(args...);
    clock_t end = clock();
    long double seconds = (long double)((end - start) * 1000) / CLOCKS_PER_SEC;
...
int main()
{
    ...
    serialTest(10, 10, 10, 1, 3800, 3800, 3800, 3800, 10, 10, 1);
    
    
    OpenMpTest(10, 10, 10, 1, 4800, 4800, 4800, 4800, 10, 10, 1);
    PPLTest(10, 10, 10, 1, 4800, 4800, 4800, 4800, 10, 10, 1);
    
    
    OpenMpTest(10, 10, 10, 1, 5800, 5800, 5800, 5800, 10, 10, 1);
    PPLTest(10, 10, 10, 1, 5800, 5800, 5800, 5800, 10, 10, 1);
    serialTest(10, 10, 10, 1, 4800, 4800, 4800, 4800, 10, 10, 1);
    serialTest(10, 10, 10, 1, 5800, 5800, 5800, 5800, 10, 10, 1);
    //getAccuracy(10);
